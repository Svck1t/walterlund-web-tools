...
SAN FRANCISCO 918, VIEL y ALDUNATE, más la familia del
producto (columna "Grupo"), usada para filtrar en la vista
de Niveles Mínimos. El resto de las columnas del export
(SAN IGNACIO, SANTIAGO CONCHA, Reservas, Disponible, etc.)
se ignoran.
...
familia: headerRow.indexOf(COL.familia), // opcional: no todos los exports la traen
...
familia: idx.familia !== -1 ? getCell(row, idx.familia) : '',
...
* con el stock de SAN FRANCISCO 918, VIEL y ALDUNATE, y su familia (Grupo)
* si el archivo la trae.
*/
